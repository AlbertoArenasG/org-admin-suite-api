...
import { GetExpirationNotificationPoliciesDto } from '@application/dto';
...
export class GetExpirationNotificationPoliciesRequestDto extends PaginationRequestDto {
  @IsOptional()
  @IsArray()
  ...
  toDomain(): GetExpirationNotificationPoliciesDto {
    return {
      page: this.getPage(),
