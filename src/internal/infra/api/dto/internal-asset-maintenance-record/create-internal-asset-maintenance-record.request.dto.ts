...
import { CreateInternalAssetMaintenanceRecordDto } from '@application/dto';
import {
...
export class CreateInternalAssetMaintenanceRecordRequestDto {
  @IsString()
  asset_name!: string;
  ...
  toDomain(actorUserId: string): CreateInternalAssetMaintenanceRecordDto {
    return {
      actorUserId,
