...
import { GetExpirationStatusPoliciesDto } from '@application/dto';
...
export class GetExpirationStatusPoliciesRequestDto extends PaginationRequestDto {
  @IsOptional()
  @IsArray()
  ...
  toDomain(): GetExpirationStatusPoliciesDto {
    return {
      page: this.getPage(),
