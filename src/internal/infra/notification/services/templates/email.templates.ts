...
const userPasswordResetTemplate = Handlebars.compile(
  `<!DOCTYPE html>
<html lang="es">
  <head>
    <meta charset="UTF-8" />
      ...
      <tr>
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 8px 20px rgba(15,23,42,0.12);">
            <tr>
              <td style="font-family:'Helvetica Neue',Arial,sans-serif;padding:40px 48px 32px;">
                <h1 style="margin:0;font-size:26px;color:#0b4abf;">Hola {{name}},</h1>
                <p style="margin:16px 0 24px;font-size:16px;line-height:1.6;color:#475569;">
                  Recibimos una solicitud para restablecer la contraseña de tu cuenta. Si fuiste tú, haz clic en el botón para crear una nueva contraseña.
                </p>
                <a href="{{link}}" style="display:inline-block;padding:14px 28px;background-color:#0b4abf;color:#ffffff;text-decoration:none;font-weight:600;border-radius:8px;">
                ...
                <p style="margin:24px 0 0;font-size:14px;line-height:1.6;color:#94a3b8;">
                  Si no solicitaste cambiar tu contraseña, ignora este correo. Tu contraseña actual seguirá siendo válida.
                </p>
              </td>
            </tr>
            <tr>
...
<html lang="es">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Servicio registrado</title>
  </head>
  <body style="margin:0;padding:0;background-color:#f5f7fb;">
    <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f5f7fb;padding:32px 0;">
      <tr>
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 8px 20px rgba(15,23,42,0.12);">
            <tr>
              <td style="font-family:'Helvetica Neue',Arial,sans-serif;padding:40px 48px 32px;">
                <h1 style="margin:0;font-size:26px;color:#0b4abf;">Hola {{contactName}},</h1>
                <p style="margin:16px 0 24px;font-size:16px;line-height:1.6;color:#475569;">
                  Se registró un nuevo servicio para la empresa <strong>{{companyName}}</strong> con folio <strong>{{serviceOrderIdentifier}}</strong>.
                </p>
                <p style="margin:0 0 24px;font-size:16px;line-height:1.6;color:#475569;">
                  Puedes consultar la información completa y descargar los archivos asociados desde el siguiente enlace:
                </p>
                <a href="{{publicUrl}}" style="display:inline-block;padding:14px 28px;background-color:#0b4abf;color:#ffffff;text-decoration:none;font-weight:600;border-radius:8px;">
                  Ver servicio
                </a>
                <p style="margin:32px 0 0;font-size:14px;line-height:1.6;color:#94a3b8;">
                  Si el botón no funciona, copia y pega este enlace en tu navegador:<br />
                  <span style="word-break:break-all;color:#0b4abf;">{{publicUrl}}</span>
                </p>
              </td>
            </tr>
            <tr>
