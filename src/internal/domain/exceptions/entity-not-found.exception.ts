...
export enum EntityNotFoundExceptionCode {
  ...
  CUSTOMER_SERVICE_RECORD_SERVICE_TYPE = 'ENTITY_NOT_FOUND.CUSTOMER_SERVICE_RECORD_SERVICE_TYPE',
  CUSTOMER_SERVICE_RECORD = 'ENTITY_NOT_FOUND.CUSTOMER_SERVICE_RECORD',
}
