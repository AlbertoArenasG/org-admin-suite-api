...
- Se ejecutó el rerun operativo de `npm run db:seed` sobre la base objetivo, dejando sincronizados `MASTER_ADMIN_DEFAULT`, `ADMIN_DEFAULT` y la limpieza de permisos de `STAFF_LEGACY` contra el catálogo final aprobado.
