...
| exports user afectados | barrels | `src/internal/application/dto/user/index.ts`, `src/internal/application/use-cases/user/index.ts`, `src/internal/infra/cqrs/queries/index.ts`, `src/internal/infra/api/presenters/user/index.ts` | Retirar exports legacy eliminados. | Artefactos legacy. | modify |
