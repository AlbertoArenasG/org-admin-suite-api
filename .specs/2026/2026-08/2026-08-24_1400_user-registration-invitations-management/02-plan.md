...
- Completar decisiones de contrato, concurrencia, persistencia y errores.

## Phase 2. Technical Design

- Diseñar DTOs, puertos, casos de uso, CQRS, persistencia y autorización según patrones existentes.
